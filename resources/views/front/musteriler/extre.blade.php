                        ...
                        <div class="widget-body clearfix">
                            <div class="widget-user-profile">
                                ...
                                <div class="profile-body">
                                    ...
                                    <h6 class="h3 profile-user-name">{{ \App\Musteriler::getPublicName($data[0]['id']) }}</h6><small class="profile-user-address">@if($data[0]['musteriTipi'] == 0) Bireysel @else Kurumsal @endif </small>
                                    <hr class="profile-seperator">
                                    <!-- /.profile-user-description -->
                                    <div class="mb-5">
                                        <a href="{{ route('musteriler.edit', ['id'=>$data[0]['id']]) }}" class="btn btn-outline-color-scheme btn-rounded btn-lg px-5 border-thick text-uppercase mr-2 mr-0-rtl ml-2-rtl fw-700 fs-11 heading-font-family">Müşteriyi Düzenle
                                        </a>
                                    </div>
                                </div>
                                <!-- /.d-flex -->
