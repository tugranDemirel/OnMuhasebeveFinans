                            ...
                            <form action="{{route('musteriler.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <div>
                                            <input type="radio" class="mr-1 change-customer-type" name="musteriTipi" id="" checked value="0"> Bireysel Müşteri
                                        </div>
                                        <div>
                                            <input type="radio" class="mr-1 change-customer-type" name="musteriTipi" id="" value="1"> Kurumsal Müşteri
                                        </div>
                                    </div>
                                </div>
