            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        <form action="{{route('kalem.update', ['id' => $data[0]['id']])}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        <input type="radio" class="mr-1 change-customer-type" name="kalemTipi" @if($data[0]['kalemTipi'] == 0) checked @endif value="0">Gelir
                                    </div>
                                    <div>
                                        <input type="radio" class="mr-1 change-customer-type" name="kalemTipi" @if($data[0]['kalemTipi'] == 1) checked @endif value="1">Gider
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row firma-area">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control"  name="kdv" value="18" value="{{ $data[0]['kdv'] }}"  type="text">
                                </div>
                            </div>
