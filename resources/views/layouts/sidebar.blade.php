...
<nav class="sidebar-nav">
    <ul class="nav in side-menu">
        ...
        <li class="menu-item-has-children"><a href="javascript:void(0);"><i class="list-icon feather feather-user"></i> <span class="hide-menu">Banka</span></a>
            ...
            @if(\App\UserPermission::getMyControl(5))
                <li class="menu-item-has-children"><a href="javascript:void(0);"><i class="list-icon feather feather-user"></i> <span class="hide-menu">İşlemler</span></a>
                    <ul class="list-unstyled sub-menu">
                        <li><a href="{{ route('islem.index') }}">İşlem Listesi</a></li>
        ...
        <li class="menu-item-has-children"><a href="javascript:void(0);"><i class="list-icon feather feather-user"></i> <span class="hide-menu">Kullanıcı</span></a>
            <ul class="list-unstyled sub-menu">
                <li><a href="{{ route('user.index') }}">Kullanıcı Listesi</a></li>
